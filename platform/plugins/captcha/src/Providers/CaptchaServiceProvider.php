...
class CaptchaServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        FormAbstract::beforeRendering(function (FormAbstract $form): void {
            ...
            if (CaptchaFacade::reCaptchaEnabled() && CaptchaFacade::formSetting($form::class, 'enable_recaptcha')) {
                $form->addBefore(
                    $fieldKey,
                    'recaptcha',
            ...
            if (CaptchaFacade::mathCaptchaEnabled() && CaptchaFacade::formSetting($form::class, 'enable_math_captcha')) {
                $form->addBefore(
                    $fieldKey,
                    'math_captcha',
