...
class ThemeOption
{
    ...
    public function getOptionKey(string $key, string|null $locale = '', string|null $theme = null): string
    {
        if (! $theme) {
            $theme = setting('theme');
            if (! $theme) {
    ...
    public function prepareFromArray(array $options, string|null $locale = null, string|null $defaultLocale = null): array
    {
